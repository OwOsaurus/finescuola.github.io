function calculateTimeRemaining() {
  ...
  const targetDate = new Date(today.getFullYear(), 5, 7); // June is 5 because January is 0 (pure il bro inizia da 0)
  const excludedDates = [
...
function updateCountdown() {
  ...
  if (currentDate.getDay() === 0 || currentDate.getDay() === 6) {
    countdownElement.innerHTML = "Il timer si ferma durante i fine settimana";
    return; // Stop the countdown
  }
  
  // If it's not a weekend, calculate and display the countdown
